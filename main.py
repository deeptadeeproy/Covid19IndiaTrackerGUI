...
layout = [[sg.Button(buttons[0], size = (30, 1))], [sg.Button(buttons[1], size = (30, 1))], [sg.Button(buttons[2], size = (30, 1))], [sg.Button(buttons[3], size = (30, 1))], [sg.Button(buttons[4], size = (30, 1))] ,[sg.Button(buttons[5], button_color = ('white', 'red'))]]
window = sg.Window("COVID19 Tracker India", layout)
